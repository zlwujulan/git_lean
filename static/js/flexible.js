! function (e, t) {
    function i() {
        ...
        /ipad.*yanxuan/.test(i) || t / s > 750 && (t = 750 * s);
        var a = t / 10;
        n.style.fontSize = a + "px", d.rem = e.rem = a
    }
    var a, r = e.document,
        n = r.documentElement,
    ...
    if (o) {
        ...
        if (p) {
            ...
            u && (s = parseFloat(u[1]), m = parseFloat((1 / s).toFixed(2))), f && (s = parseFloat(f[1]), m = parseFloat((
                1 / s).toFixed(2)))
        }
    }
    if (!s && !m) {
    ...
    if (n.setAttribute("data-dpr", s), !o) if (o = r.createElement("meta"), o.setAttribute("name", "viewport"), e.webPageScalable ?
        o.setAttribute("content", "initial-scale=" + m + ", user-scalable=yes") : o.setAttribute("content",
            "initial-scale=" + m + ", maximum-scale=" + m + ", minimum-scale=" + m +
            ", user-scalable=no viewport-fit=cover"), n.firstElementChild) n.firstElementChild.appendChild(o);
    else {
    ...
    }, !1), "complete" === r.readyState ? r.body.style.fontSize = 12 * s + "px" : r.addEventListener("DOMContentLoaded", function (
        e) {
